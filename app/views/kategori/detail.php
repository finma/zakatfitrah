...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4 w-50">
    <h1 class="h3 mb-0 text-gray-800">Detail Kategori Mustahik</h1>
  </div>
  ...
  <div class='row w-50'>
    <form class='col-md'>
      <div class="mb-3">
        ...
        <input class="form-control" id="nama_kategori" name="nama_kategori" type="text" placeholder="" value="<?= $data['dataKategori']['nama_kategori'] ?>" disabled>
      </div>
      <div class="mb-3">
        <label for="jumlah_hak">Jumlah Tanggungan</label>
        <input class="form-control" id="jumlah_hak" name="jumlah_hak" type="number" placeholder="" value="<?= $data['dataKategori']['jumlah_hak'] ?>" disabled>
      </div>
