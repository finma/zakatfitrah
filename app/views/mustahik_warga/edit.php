...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4 w-50">
    <h1 class="h3 mb-0 text-gray-800">Update Data Mustahik Warga</h1>
  </div>

  <div class='row w-50'>
    <form class='col-md' action="<?= BASEURL; ?>/mustahikwarga/update/<?= $data['dataMustahikWarga']['id_mustahikwarga'] ?>" method="POST">
      <div class="mb-3">
        <label for="nama">Nama</label>
        <input required class="form-control" id="nama" name="nama" type="text" value="<?= $data['dataMustahikWarga']['nama'] ?>">
      </div>
      <div class="mb-3">
        <label for="kategori">Kategori</label>
        <select required class="custom-select" id="kategori" name="kategori" value="<?= $data['dataMustahikWarga']['kategori'] ?>">
      ...
      <div class="mb-3">
        ...
        <input required class="form-control" id="hak" name="hak" type="number" value="<?= $data['dataMustahikWarga']['hak'] ?>">
      </div>
