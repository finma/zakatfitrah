...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4 w-50">
    <h1 class="h3 mb-0 text-gray-800">Detail Data Pengumpulan Zakat Fitrah</h1>
  </div>
  ...
  <div class='row w-50'>
    <form class='col-md' action="<?= BASEURL; ?>/pengumpulanzakatfitrah/post" method="POST">
      <div class="mb-3">
        ...
        <input disabled required class="form-control" id="nama_KK" name="nama_KK" type="text" value="<?= $data['dataZakat']['nama_KK'] ?>">
      </div>
      <div class="mb-3">
        <label for="jumlah_tanggungan">Jumlah Tanggungan</label>
        <input disabled required class="form-control" id="jumlah_tanggungan" name="jumlah_tanggungan" type="number" value="<?= $data['dataZakat']['jumlah_tanggungan'] ?>">
      </div>
      <div class="mb-3">
        <label for="jenis_bayar">Jenis Bayar</label>
        <select disabled required class="custom-select" id="jenis_bayar" name="jenis_bayar">
      ...
      <div class="mb-3">
        ...
        <input disabled required class="form-control" id="jumlah_tanggunganyangdibayar" name="jumlah_tanggunganyangdibayar" type="number" value="<?= $data['dataZakat']['jumlah_tanggunganyangdibayar'] ?>">
      </div>
      <div class="mb-3">
        <label for="bayar_beras">Bayar Beras (Kg)</label>
        <input disabled required class="form-control" id="bayar_beras" name="bayar_beras" type="number" step="0.01" value="<?= $data['dataZakat']['bayar_beras'] ?>">
      </div>
      <div class="mb-3">
        <label for="bayar_uang">Bayar Uang (Rp)</label>
        <input disabled required class="form-control" id="bayar_uang" name="bayar_uang" type="number" step="0.01" value="<?= $data['dataZakat']['bayar_uang'] ?>">
      </div>
  ...
  <script>
    ...
    const jumlahTanggunganBayar = document.querySelector('#jumlah_tanggungan_yang_dibayar')
