...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4 w-50">
    <h1 class="h3 mb-0 text-gray-800">Tambah Muzakki</h1>
  </div>

  <div class='row w-50'>
    <form action="<?= BASEURL; ?>/muzakki/post" method="POST" class='col-md'>
      <div class="mb-3">
        <label for="nama_muzakki">Nama Muzakki </label>
        <input class="form-control" id="nama_muzakki" name="nama_muzakki" type="text">
      </div>
      <div class="mb-3">
        <label for="jumlah_tanggungan">Jumlah Tanggungan</label>
        <input class="form-control" id="jumlah_tanggungan" name="jumlah_tanggungan" type="number">
      </div>
      <div class="mb-0">
